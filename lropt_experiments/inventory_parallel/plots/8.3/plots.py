...
path = "/Users/irina.wang/Desktop/Princeton/Project2/lropt_experiments/lropt_experiments/inventory_parallel/plots/8.3/"
R = 5
etas = [0.10,0.20,0.25,0.30,0.33,0.35,0.40,0.50]
objs = [0.5,1,2]
...
foldername1 = "/Users/irina.wang/Desktop/Princeton/Project2/lropt_experiments/inv_results/2025-05-05/2/"
foldername3 = "/Users/irina.wang/Desktop/Princeton/Project2/lropt_experiments/inv_results/2025-05-05/2/"
...
foldername21 = "/Users/irina.wang/Desktop/Princeton/Project2/lropt_experiments/inv_results/2025-05-05/2/"
foldername41 = "/Users/irina.wang/Desktop/Princeton/Project2/lropt_experiments/inv_results/2025-05-05/2/"
...
df_pre = []
running_ind = 0
newfolder = foldername21+str(running_ind)
for seed in range(R):
    try:
...
running_ind = 0
newfolder = foldername41+str(running_ind)
for seed in range(R):
    try:
        df = pd.read_csv(newfolder+'/'+str(seed)+"_linear_untrained_grid.csv")
        df['seed'] = seeds2[seed]
...
def plot_compare(dfs,idx,dfs_grid,dfs_mv_grid,valid,ylim=None):
    ...
    if valid:
        ...
        plt.savefig(path+"Validation objectives_"+"gamma_"+str(idx)+".pdf",bbox_inches = "tight")
    else:
        plt.title("Test objectives_"+"gamma_"+str(idx))
        plt.savefig(path+"Test objectives_"+"gamma_"+str(idx)+".pdf",bbox_inches = "tight")
for idx in objs:
...
def plot_best(plot_data,dfs,dfs_grid,dfs_mv_grid,ylim=None):
    ...
    plt.vlines(target_list,ymin = np.min(plot_data["test_obj"]),ymax=np.max(plot_data["mv_obj"]),linestyles=":",color = "red",alpha = 0.5)
