...
path = "/Users/irina.wang/Desktop/Princeton/Project2/lropt_experiments/lropt_experiments/inventory_parallel/plots/4/"
R = 5
etas = [0.05,0.10,0.15,0.20,0.25,0.30,0.33,0.35,0.40,0.50]
objs = [0.5,1,2]
seeds1 = [0,10,20,30,40]
seeds2 = [50,60,70,80,90]
foldername1 = "/Users/irina.wang/Desktop/Princeton/Project2/lropt_experiments/inv_results/2025-05-01/04-41-52/"
foldername2 = "/Users/irina.wang/Desktop/Princeton/Project2/lropt_experiments/inv_results/2025-05-01/23-04-46/"
dfs_all = {}
quantiles = [0.25,0.75]
dfs = {}
running_ind = 0
...
inds = {}
# target_list = [0.04,0.09,0.14]
target_list = [0.01,0.025,0.04,0.065,0.09,0.12,0.14,0.16,0.18]
target_list1 = [0.05,0.1,0.15]
dfs_best = {}
dif=0.01
curdif = dif
...
def plot_best(plot_data,dfs,dfs_grid,dfs_mv_grid,ylim=None):
    ...
    plt.vlines(target_list1,ymin = np.min(plot_data["test_obj"]),ymax=np.max(dfs_grid["mean_Test_val"]),linestyles=":",color = "red",alpha = 0.5)
    ...
    plt.savefig(path+"Test_objectives_best_all_10_o.pdf",bbox_inches = "tight")
plot_best(plot_data,dfs,dfs_grid,dfs_mv_grid,ylim = (-415,-380))
