...
def inv_exp(cfg,hydra_out_dir,seed):
    ...
    try: 
        ...
        settings.predictor = lropt.LinearPredictor(predict_mean = True,pretrain=True, lr=0.001,epochs = 100,knn_cov=True,n_neighbors=int(N*0.3*0.1),knn_scale = cfg.knn_mult)
