...
foldername1 = "/Users/irina.wang/Desktop/Princeton/Project2/lropt_experiments/news_results/worst_new/bi/0.5/"
foldername4 = "/Users/irina.wang/Desktop/Princeton/Project2/lropt_experiments/news_results/worst_new/bi/0.5/"
dfs_all = {}
quantiles = [0.25,0.75]
dfs = {}
running_ind = 0
...
for target in target_list:
    ...
    for seed in seeds1:
        try:
            ...
            if mindif >= dif:
                curdif = mindif
            best_idx = np.argmin(df_mv[df_mv["seed"] == seed][abs(df_mv[df_mv["seed"] == seed]["Avg_prob_validate"] - target)<=curdif]["Validate_worst"])
...
for target in target_list:
    ...
    for seed in seeds1:
        try:
            ...
            if mindif >= dif:
                curdif = mindif
            best_idx = np.argmin(df_pre[df_pre["seed"] == seed][abs(df_pre[df_pre["seed"] == seed]["Avg_prob_validate"] - target)<=curdif]["Validate_worst"])
