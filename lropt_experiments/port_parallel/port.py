...
def portfolio_exp(cfg,hydra_out_dir,seed):
    ...
    result_grid4 = trainer.grid(rholst=[0.25,0.5,1,2],init_A=A_fin, init_b=b_fin, seed=5,init_alpha=0., test_percentage=test_p,quantiles = (0.3,0.7), contextual = True, predictor = result._predictor)
...
@hydra.main(config_path="/Users/irina.wang/Desktop/Princeton/Project2/lropt_experiments/lropt_experiments/port_parallel/configs",config_name = "port.yaml", version_base = None)
def main_func(cfg):
