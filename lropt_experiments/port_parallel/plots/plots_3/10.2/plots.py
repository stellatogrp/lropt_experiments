...
path = "/Users/irina.wang/Desktop/Princeton/Project2/lropt_experiments/lropt_experiments/port_parallel/plots/plots_3/10.2/"
R = 10
...
foldername1 = "/Users/irina.wang/Desktop/Princeton/Project2/lropt_experiments/port_results/cvar/fixed/10_1000/"
foldername4 = "/Users/irina.wang/Desktop/Princeton/Project2/lropt_experiments/port_results/cvar/obj_4/10_1000/"
foldername3 = "/Users/irina.wang/Desktop/Princeton/Project2/lropt_experiments/port_results/cvar/DRO/10_1000/"
foldername5 = "/Users/irina.wang/Desktop/Princeton/Project2/lropt_experiments/port_results/cvar/Delage/10_1000/"
foldername6_1 = "/Users/irina.wang/Desktop/Princeton/Project2/lropt_experiments/port_results/cvar/lcx/10_1000.1/"
foldername6_2 = "/Users/irina.wang/Desktop/Princeton/Project2/lropt_experiments/port_results/cvar/lcx/10_1000.2/"
dfs_all = {}
quantiles = [0.25,0.75]
dfs = {}
running_ind = 0
...
dfs_lcx = []
running_ind = 4
newfolder1 = foldername6_1+str(running_ind)
newfolder2 = foldername6_2+str(running_ind)
for seed in seeds1:
    for comp in range(20):
        try:
            df = pd.read_csv(newfolder1+'/'+str(seed)+'_'+str(comp)+"_vals_lcx.csv")
            dfs_lcx.append(df)
        except:
            print(6,comp,seed)
        try:
            df = pd.read_csv(newfolder2+'/'+str(seed)+'_'+str(comp)+"_vals_lcx.csv")
            dfs_lcx.append(df)
        except:
            print(6,comp,seed)
