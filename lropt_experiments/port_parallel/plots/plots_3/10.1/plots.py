...
foldername4 = "/Users/irina.wang/Desktop/Princeton/Project2/lropt_experiments/port_results/cvar/obj_1/10_2000/"
...
for target in target_list:
    ...
    "test_avg": dfs_best[target]["avg_val"].mean(), "test_avg_o": dfs_best_o[target]["avg_val"].mean(), "test_avg_mv": dfs_best_mv[target]["Test_other_obj"].mean(), "test_avg_pre": dfs_best_pre[target]["Test_other_obj"].mean(), 
            ...
            "test_avg_dro": dfs_best_dro[target]["Test_other_obj"].mean(),"test_avg_scene":df_nonrob["scenario_avg"].mean()
            }
