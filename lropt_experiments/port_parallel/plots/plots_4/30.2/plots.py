...
path = "/Users/irina.wang/Desktop/Princeton/Project2/lropt_experiments/lropt_experiments/port_parallel/plots/plots_4/30.2/"
R = 10
...
foldername1 = "/Users/irina.wang/Desktop/Princeton/Project2/lropt_experiments/port_results/worst/fixed/30_1000/"
foldername4 = "/Users/irina.wang/Desktop/Princeton/Project2/lropt_experiments/port_results/worst/bi/30_1000/"
foldername3 = "/Users/irina.wang/Desktop/Princeton/Project2/lropt_experiments/port_results/worst/dro_sep/30_1000/"
foldername5 = "/Users/irina.wang/Desktop/Princeton/Project2/lropt_experiments/port_results/worst/delage/30_1000/"
foldername6 = "/Users/irina.wang/Desktop/Princeton/Project2/lropt_experiments/port_results/worst/lcx/30_1000/"
foldername7 = "/Users/irina.wang/Desktop/Princeton/Project2/lropt_experiments/port_results/worst/dro/30_1000/"
dfs_all = {}
quantiles = [0.25,0.75]
dfs = {}
# running_ind = 0
...
for target in target_list:
    ...
    "0.25_test_avg_pre": dfs_best_pre[target]["Test_val"].quantile(0.25),"0.75_test_avg_pre": dfs_best_pre[target]["Test_val"].quantile(0.75),
            ...
            "test_in":dfs_best[target]["test_in"].mean(), 
            "test_in_lcx": dfs_best_lcx[target]["in_val"].mean(),
            "test_in_o": dfs_best_o[target]["test_in"].mean(),"test_in_pre":dfs_best_pre[target]["Test_insample"].mean(), "test_in_mv":dfs_best_mv[target]["Test_insample"].mean(), "test_in_scene":df_nonrob["scenario_in"].mean(), "test_in_dro": dfs_best_dro[target]["Test_insample"].mean(),
             "test_in_dro1": dfs_best_dro1[target]["Test_insample"].mean(),
            ...
            'test_dro_cvar1':dfs_best_dro1[target]["Test_cvar"].mean(), '0.25_dro_cvar1':dfs_best_dro1[target]["Test_cvar"].quantile(0.25),  '0.75_dro_cvar1':dfs_best_dro1[target]["Test_cvar"].quantile(0.75),
...
def plot_best_in(plot_data,ylim=None):
    ...
    plt.plot(np.array(plot_data["lcx_prob"]),np.array(plot_data["test_in_lcx"]), label = "LCX test" ,color = "tab:pink",marker = "s")
...
def plot_best_cvar(plot_data,ylim=None):
    idx = 1
    plt.figure(figsize = (8,4))
    plt.plot(np.array(plot_data["mv_prob"]),np.array(plot_data["test_mv_cvar"]), label = "MV test" ,color = "tab:blue",marker = "^")

    plt.plot(np.array(plot_data["test_prob_o"]),np.array(plot_data["test_o_cvar"]), label = "Trained test delage" ,color = "tab:brown",marker = "D")
    
    plt.plot(np.array(plot_data["test_prob"]),np.array(plot_data["test_cvar"]), label = "Trained test" ,color = "tab:orange",marker = "D")

    plt.plot(np.array(plot_data["pre_prob"]),np.array(plot_data["test_pre_cvar"]), label = "Pretrained test" ,color = "tab:green",marker = "v")
    
    plt.plot(np.array(plot_data["dro_prob"]),np.array(plot_data["test_dro_cvar"]), label = "DRO test" ,color = "tab:olive",marker = "v")

    plt.plot(np.array(plot_data["scenario_prob"]),np.array(plot_data["test_scene_cvar"]),label = "Scenario test",color = "tab:purple",marker = "o")
    plt.plot(np.array(plot_data["lcx_prob"]),np.array(plot_data["test_lcx_cvar"]), label = "LCX test" ,color = "tab:pink",marker = "s")
