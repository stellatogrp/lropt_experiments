...
def portfolio_exp(cfg,hydra_out_dir,seed,initseed, sig,mu,orig_mu,N,n,train_indices,context,eps_list):
    ...
    u = lropt.UncertainParameter(n,
                            uncertainty_set=lropt.MRO(K=1, p=2, data=data, train_data=train, train=True))
...
@hydra.main(config_path="configs",config_name = "port_dro_30_2000.yaml", version_base = None)
def main_func(cfg):
    ...
    Parallel(n_jobs=njobs)(
        delayed(portfolio_exp)(cfg,hydra_out_dir,r,initseed, sig,mu,orig_mu,N,n,train_indices,context,eps_list) for r in range(R))
