...
# Train A and b
result = prob.train(lr=0.001, num_iter=100, optimizer="Adam",
                    seed=s, init_A=initn, init_b=init_bvaln, init_lam=0.5, init_mu=0.01,
                    mu_multiplier=1.001, init_alpha=0., test_percentage = test_p,save_history = True, quantiles = (0.4,0.6), lr_step_size = 200, random_init = True, num_random_init = 6, parallel = True)
df = result.df
A_fin = result.A
b_fin = result.b
