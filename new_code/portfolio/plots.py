...
prob_st = []
prob_re = []
nvals = np.array([50,80,100,300,500,1000,1500,2000])
for N in nvals:
    ...
    # plot_coverage_all(dfgrid,dfgrid2,None, f"results/results0/port(N,m)_{N,n}",f"port(N,m)_{N,n}",ind_1=(0,10000),ind_2=(0,10000), logscale = False, zoom = False,legend = True)
