...
for target in target_list:
    ...
    "0.25_test_avg_pre": dfs_best_pre[target]["Test_val"].quantile(0.25),"0.75_test_avg_pre": dfs_best_pre[target]["Test_val"].quantile(0.75),
            ...
            "0.25_test_avg_dro_aggr": dfs_best_dro1[target]["Test_val"].quantile(0.25),"0.75_test_avg_dro_aggr": dfs_best_dro1[target]["Test_val"].quantile(0.75),
            ...
            "test_scene_cvar":df_nonrob["scenario_cvar"].mean(),'test_dro_cvar_aggr':dfs_best_dro1[target]["Test_cvar"].mean(), '0.25_dro_cvar_aggr':dfs_best_dro1[target]["Test_cvar"].quantile(0.25),  '0.75_dro_cvar_aggr':dfs_best_dro1[target]["Test_cvar"].quantile(0.75),
            }
